# Contributing to hzb-metadata-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
hzb-metadata-schema. These guidelines are not strict rules.
...
The hzb-metadata-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the hzb-metadata-schema technical leads
...
[issues]: https://github.com/anak-velazquez/hzb-metadata-schema/issues/
[pulls]: https://github.com/anak-velazquez/hzb-metadata-schema/pulls/
